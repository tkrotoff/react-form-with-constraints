...
function shallow(
  ...
  options: { context: FieldFeedbackContext }
) {
...
describe('constructor()', () => {
  test('key', () => {
    ...
    const wrapper1 = shallow(<FieldFeedback when="*">message</FieldFeedback>, {
    ...
    const wrapper2 = shallow(<FieldFeedback when="*">message</FieldFeedback>, {
      context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
    });
  ...
  test('when="valid"', () => {
    expect(() =>
      shallow(<FieldFeedback when="valid" error />, {
        context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
      })
    ).toThrow('Cannot have an attribute (error, warning...) with FieldFeedback when="valid"');

    expect(() =>
      shallow(<FieldFeedback when="valid" warning />, {
        context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
      })
    ).toThrow('Cannot have an attribute (error, warning...) with FieldFeedback when="valid"');

    expect(() =>
      shallow(<FieldFeedback when="valid" info />, {
        context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
      })
    ).toThrow('Cannot have an attribute (error, warning...) with FieldFeedback when="valid"');
  });
...
test('componentDidMount() componentWillUnmount()', () => {
  ...
  const wrapper = shallow(<FieldFeedback when="*" />, {
    context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
  });
...
describe('validate()', () => {
  describe('when prop', () => {
    describe('string', () => {
      test('unknown', async () => {
        shallow(<FieldFeedback when={'unknown' as any} />, {
          context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
        });
      ...
      test('not matching', async () => {
        shallow(<FieldFeedback when="badInput" />, {
          context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
        });
        const validations = await fieldFeedbacks_username.emitValidateFieldEvent(
          input_username_valueMissing
      ...
      test('badInput', async () => {
        ...
        const input = new InputElementMock(
          'username',
          '',
          { valid: false, badInput: true },
      ...
      test('patternMismatch', async () => {
        shallow(<FieldFeedback when="patternMismatch" />, {
          context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
        });
        const input = new InputElementMock(
          'username',
      ...
      test('rangeOverflow', async () => {
        shallow(<FieldFeedback when="rangeOverflow" />, {
          context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
        });
        const input = new InputElementMock(
          'username',
      ...
      test('rangeUnderflow', async () => {
        shallow(<FieldFeedback when="rangeUnderflow" />, {
          context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
        });
        const input = new InputElementMock(
          'username',
          '',
          { valid: false, rangeUnderflow: true },
      ...
      test('stepMismatch', async () => {
        shallow(<FieldFeedback when="stepMismatch" />, {
          context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
        });
        const input = new InputElementMock(
          'username',
          '',
          { valid: false, stepMismatch: true },
      ...
      test('tooLong', async () => {
        shallow(<FieldFeedback when="tooLong" />, {
          context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
        });
        const input = new InputElementMock(
          'username',
          '',
          { valid: false, tooLong: true },
      ...
      test('tooShort', async () => {
        shallow(<FieldFeedback when="tooShort" />, {
          context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
        });
        const input = new InputElementMock(
          'username',
          '',
          { valid: false, tooShort: true },
      ...
      test('typeMismatch', async () => {
        shallow(<FieldFeedback when="typeMismatch" />, {
          context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
        });
        const input = new InputElementMock(
          'username',
          '',
          { valid: false, typeMismatch: true },
          'Suffering from bad input'
        );
        const validations = await fieldFeedbacks_username.emitValidateFieldEvent(input);
      ...
      test('valueMissing', async () => {
        shallow(<FieldFeedback when="valueMissing" />, {
          context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
        });
        const validations = await fieldFeedbacks_username.emitValidateFieldEvent(
          input_username_valueMissing
      ...
      test('valid', async () => {
        shallow(<FieldFeedback when="valid">Looks good!</FieldFeedback>, {
          context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
        });
        const validations = await fieldFeedbacks_username.emitValidateFieldEvent(
          input_username_valueMissing
        ...
        expect(validations).toEqual([{ key: '0.0', type: 'whenValid', show: undefined }]);
      });
    });

    describe('function', () => {
      test('no error', async () => {
        shallow(<FieldFeedback when={value => value.length === 0} />, {
          context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
        });
        const validations = await fieldFeedbacks_username.emitValidateFieldEvent(
          input_username_valid
    ...
    test('invalid typeof', async () => {
      shallow(<FieldFeedback when={2 as any} />, {
        context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
      });
      await expect(
  ...
  test('error prop', async () => {
    const wrapper = mount(<FieldFeedback when="*" error />, {
      context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
    });
    const validations = await fieldFeedbacks_username.emitValidateFieldEvent(
      input_username_valueMissing
  ...
  test('warning prop', async () => {
    shallow(<FieldFeedback when="*" warning />, {
      context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
    });
    const validations = await fieldFeedbacks_username.emitValidateFieldEvent(
      input_username_valueMissing
  ...
  test('info prop', async () => {
    shallow(<FieldFeedback when="*" info />, {
      context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
    });
    const validations = await fieldFeedbacks_username.emitValidateFieldEvent(
      input_username_valueMissing
...
describe('render()', () => {
  ...
  test('warning', async () => {
    const wrapper = mount(
      <FieldFeedback when={value => value.length === 0} warning>
        Cannot be empty
      </FieldFeedback>,
      { context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username } }
    );
  ...
  test('info', async () => {
    const wrapper = mount(
      <FieldFeedback when={value => value.length === 0} info>
        Cannot be empty
      </FieldFeedback>,
      { context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username } }
    );
  ...
  test('without children', async () => {
    const wrapper = mount(<FieldFeedback when={value => value.length === 0} />, {
      context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username }
    });
    const validations = await fieldFeedbacks_username.emitValidateFieldEvent(
      input_username_valueMissing
  ...
  test('with already existing class', async () => {
    const wrapper = mount(
      <FieldFeedback when={value => value.length === 0} className="alreadyExistingClassName">
        Cannot be empty
      </FieldFeedback>,
      { context: { form: form_username, fieldFeedbacks: fieldFeedbacks_username } }
    );
